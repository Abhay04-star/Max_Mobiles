...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="Itanagar" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" placeholder="Arunachal Pradesh" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
